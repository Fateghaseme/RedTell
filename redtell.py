...
def get_train_test_datasets(images_dir, test_size=0.2, batch_size=32):
    # اعمال تبدیل‌های پایه برای داده‌ها
    transform = transforms.Compose([
        transforms.Resize((224, 224)),  # اندازه‌دهی به تصاویر
        transforms.ToTensor(),  # تبدیل تصاویر به تنسور
    ])

    # بارگذاری داده‌ها از پوشه images_dir
    full_dataset = datasets.ImageFolder(root=images_dir, transform=transform)
    ...
    # بارگذاری داده‌ها در DataLoader‌ها
